  ...
  <div className="container py-5">
    <div className="row d-flex align-items-center justify-content-center">
      ...
      {message}
        ...
        <img src="https://t3.ftcdn.net/jpg/05/62/89/30/360_F_562893098_MKEnicrHA2E4mS69t569PCXIflEMAAuu.jpg"
      ...
      <div className="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        <form method='POST' onSubmit={handleLoginSubmit}>
          {/* <!-- Email input --> */}
          <div className=" mb-4">
            <input type="email" name='email' id="form1Example13" className="form-control form-control-lg" style={{ color: 'white' }}/>
