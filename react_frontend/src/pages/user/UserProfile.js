      ...
      <div className="col-md-12 col-xl-4">
        ...
        <div className="card" style={{borderRadius:'15px'}}>
          <div className="card-body text-center">
            ...
            <p className=" mb-1">Email: {userDetails?.email} <span className="mx-2"></span> </p>
            <p className=" mb-2">Phone number: {userDetails?.phone_number} <span className="mx-2"></span> </p><br></br>
