        ...
        <div className="col-12 col-md-8 col-lg-6 col-xl-5">
          <div className="card shadow-2-strong" style={{borderRadius: '1rem'}}>
           ...
           <input type="checkbox" name="is_active" checked={userData.is_active} onChange={handleInputChange} />
              ...
              <button className="btn btn-orange btn-lg btn-block my-2 "style={{ backgroundColor: '#FF8C00', color: 'white' }} type="button" onClick={handleDelete}>Delete This User</button>
